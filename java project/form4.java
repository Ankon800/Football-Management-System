...
public class form4 extends JFrame implements ActionListener
{
	...
	form4()
	{
		...
		l9 = new JRadioButton("    Real Madrid   VS   Fc Barcelona ");
		l9.setFont(new Font("Comic Sans MS",Font.BOLD,15));
		l9.setForeground(Color.blue);
		l9.setBounds(240,390,350,30);
